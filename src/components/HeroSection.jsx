...
const HeroSection = () => {
  return (
    ...
    >
      ...
      {/* Text Content */}
      <div className="relative md:h-60 h-20 z-10  flex items-center justify-center text-white text-center px-4">
   
        <div className="md:mt-77 mt-66">
          <h1 className="text-2xl md:text-5xl font-serif mb-4">
